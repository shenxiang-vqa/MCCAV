...
def parse_args():
    ...
    parser.add_argument('--DATASET', dest='DATASET',
                      choices=['vqa', 'gqa', 'clevr','vqa_grid','vqa_grid16'],
                      help='{'
                           'vqa,'
                           'gqa,'
                           'clevr,'
    ...
    parser.add_argument('--gF', dest='gF',
                      choices=['True', 'False'],
                      help='choose wether fusion global language feature g',
                      type=str)
    
    
    parser.add_argument('--Ctype', dest='USE_CONTEXT',
                      choices=['None', 'deep', 'global', 'deep-global', 'deep-global-deep', 'deep-global-global'],
    ...
    parser.add_argument('--BERT', dest='BERT_USE',
                      choices=['False', 'True'],
                      help='choose whether use bert for language embeding',
                      type=str)
